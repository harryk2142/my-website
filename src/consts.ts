...
export const SUB_TITLE = "A mystery blog";
...
export const SITE_DESCRIPTION_LONG =
  ...
  "Entdecke unsere Kolumnen, in denen wir die absurdesten Nachrichtenüberschriften präsentieren oder surreal anmutende Alltagsszenarien humorvoll beleuchten. Wir laden dich ein, Teil einer Community zu sein, die den Wert des Lachens und der außergewöhnlichen Geschichten schätzt. " +
  "Begib dich auf eine Reise in eine Welt voller künstlicher Intelligenz und sarkastischem Charme. Lass dich von unseren AI-generierten Artikeln überraschen, inspirieren und zum Lachen bringen. Bereite dich darauf vor, das Gewöhnliche zu verlassen und das Ungewöhnliche zu umarmen. " +
  "Bist du bereit für ein humorvolles Abenteuer? Dann folge uns auf [Blogname], wo AI und Satire auf unerwartete Weise aufeinandertreffen!";
